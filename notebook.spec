...
%prep
%setup -q -n notebook-6.0.3
cd %{_builddir}/notebook-6.0.3
...
cp %{_builddir}/notebook-6.0.3/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
