...
Source0  : https://files.pythonhosted.org/packages/a9/86/7313fa3a401c9e0c068b2992ec50b7ec56abf3731f4ce3af17ed80f6c4b6/notebook-6.1.3.tar.gz
...
%prep
%setup -q -n notebook-6.1.3
cd %{_builddir}/notebook-6.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597328269
...
cp %{_builddir}/notebook-6.1.3/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
