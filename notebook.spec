...
Source0  : https://files.pythonhosted.org/packages/0b/92/7e4ef9e4cbe56f289b86d9df5bd3f6bc24a1ed59da5a1d0d0c4fa7fb8771/notebook-6.1.4.tar.gz
...
%prep
%setup -q -n notebook-6.1.4
cd %{_builddir}/notebook-6.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599602420
...
cp %{_builddir}/notebook-6.1.4/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
