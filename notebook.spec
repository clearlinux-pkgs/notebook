...
Source0  : https://files.pythonhosted.org/packages/6c/f9/3d3756a76beb56e5b4e3a892383024fb5c157688efb8241af69786a20d8e/notebook-6.4.4.tar.gz
...
%prep
%setup -q -n notebook-6.4.4
cd %{_builddir}/notebook-6.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631726944
...
cp %{_builddir}/notebook-6.4.4/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
