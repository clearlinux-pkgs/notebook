...
Source0  : https://files.pythonhosted.org/packages/bb/7b/de620d82888929137f565334246d6553e2d1b7880a0fc5bb6b511a143610/notebook-6.4.1.tar.gz
...
%prep
%setup -q -n notebook-6.4.1
cd %{_builddir}/notebook-6.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628212669
...
cp %{_builddir}/notebook-6.4.1/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
