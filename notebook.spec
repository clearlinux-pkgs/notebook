...
Source0  : https://files.pythonhosted.org/packages/84/99/5c73a5d9b4743b25e2fc53a76050838f9c46834e7fe702be8d3b0c3affb7/notebook-6.1.6.tar.gz
...
%prep
%setup -q -n notebook-6.1.6
cd %{_builddir}/notebook-6.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609271461
...
cp %{_builddir}/notebook-6.1.6/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
