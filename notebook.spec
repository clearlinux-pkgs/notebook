...
Source0  : https://files.pythonhosted.org/packages/a0/3a/a8109b2df61a25fce11eda502a03165a26d36267d39ae07ddbd5855ca934/notebook-6.2.0.tar.gz
...
%prep
%setup -q -n notebook-6.2.0
cd %{_builddir}/notebook-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610578283
...
cp %{_builddir}/notebook-6.2.0/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
