...
%prep
%setup -q -n notebook-6.3.0
cd %{_builddir}/notebook-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616425642
...
cp %{_builddir}/notebook-6.3.0/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
