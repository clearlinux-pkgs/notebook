...
Source0  : https://files.pythonhosted.org/packages/72/43/c44dc0e801df9eae326747fee604bdfb094442cc9ee3c04020d836e46a7e/notebook-6.4.3.tar.gz
...
%prep
%setup -q -n notebook-6.4.3
cd %{_builddir}/notebook-6.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628698080
...
cp %{_builddir}/notebook-6.4.3/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
