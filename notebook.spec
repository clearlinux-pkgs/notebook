...
Source0  : https://files.pythonhosted.org/packages/af/f5/9b852c8ff8e911637e5b47834b4dce0d4fe31b4ece72667e9fbffa42c0fe/notebook-6.4.0.tar.gz
...
%prep
%setup -q -n notebook-6.4.0
cd %{_builddir}/notebook-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621265868
...
cp %{_builddir}/notebook-6.4.0/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
