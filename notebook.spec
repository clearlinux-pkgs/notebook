...
Version  : 6.1.2
Release  : 52
URL      : https://files.pythonhosted.org/packages/28/d8/a5659564e0ad4517fb23971896b45518dfc050bc0e069f263012dabe2546/notebook-6.1.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/28/d8/a5659564e0ad4517fb23971896b45518dfc050bc0e069f263012dabe2546/notebook-6.1.2.tar.gz
...
%prep
%setup -q -n notebook-6.1.2
cd %{_builddir}/notebook-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597276078
...
cp %{_builddir}/notebook-6.1.2/LICENSE %{buildroot}/usr/share/package-licenses/notebook/16d10493731a4bebeb353de88f3427006e13da11
